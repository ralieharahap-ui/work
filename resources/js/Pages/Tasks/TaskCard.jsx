import { CheckCircleIcon, ClockIcon, ChatBubbleLeftEllipsisIcon } from '@heroicons/react/24/outline';
import { PRIORITY_BADGE, KANBAN_EDITABLE_STATUSES, fmtDateShort } from './constants';

export default function TaskCard({ task, onEdit, onStatusChange, onCloseRequest, canEdit }) {
                ...
                {canEdit && (
                    <div className="flex items-center gap-1">
                        {task.status !== 'Done' && (
                            <button
                                type="button"
                                title="Tandai Selesai (unggah bukti)"
                        ...
                        <select
                            ...
                            className="text-[11px] border border-transparent bg-warm-white hover:border-black/10 rounded px-1 py-0.5 text-warm-500 outline-none cursor-pointer"
                        >
