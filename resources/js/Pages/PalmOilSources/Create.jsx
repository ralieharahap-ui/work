...
export default function PalmOilSourceCreate() {
    const form = useForm({
        name: '',
        supplier_name: '',
        latitude: '',
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('palm-oil-sources.store'));
    };

    return (
        <>
            <Head title="Tambah Sumber Cangkang Sawit" />
            <AppLayout title="Tambah Sumber Cangkang Sawit">
                <div className="mb-4">
                    <Link
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Contoh: Sumber PKS Riau"
                                        required
                                    />
                                    {form.errors.name && (
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="PT Biomassa Indonesia"
                                    />
                                </div>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Contoh: Sumber utama musim panen..."
                                />
                            </div>
                        </div>
