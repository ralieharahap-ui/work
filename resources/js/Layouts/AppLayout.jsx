...
// `biomassa: true` menandai menu milik modul biomassa & akuntansi (mode 'full')
// — disembunyikan saat aplikasi dijalankan dalam mode khusus manajemen tugas (APP_MODE=tasks).
const nav = [
    { label: 'Dashboard',        href: '/',                   icon: MapDashboardIcon,   perm: null,               biomassa: true, group: 'Supply Chain' },
    { label: 'Sumber Cangkang',  href: '/palm-oil-sources',   icon: PalmPlantationIcon, perm: 'inventory.view',   biomassa: true, group: 'Supply Chain' },
    { label: 'Titik Bongkar',    href: '/unloading-points',   icon: IndustryIcon,       perm: 'inventory.view',   biomassa: true, group: 'Supply Chain' },
    ...
    { label: 'Daftar Aset',      href: '/books/fixed-assets',  icon: AssetColorIcon,    perm: 'books.view', biomassa: true, group: 'Akuntansi' },
    { label: 'Master Vendor',    href: '/books/vendors',       icon: VendorColorIcon,   perm: 'books.view', biomassa: true, group: 'Akuntansi' },
    { label: 'Master Customer',  href: '/books/customers',     icon: IndustryIcon,      perm: 'books.view', biomassa: true, group: 'Akuntansi' },
